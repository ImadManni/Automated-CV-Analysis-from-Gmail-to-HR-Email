...
const AVATAR_EMBED_URL =
  'https://sketchfab.com/models/f6875afc0b3c4d19a17a8147f0b13626/embed?autostart=1&ui_hint=2&ui_infos=0&ui_watermark=0&ui_help=0&dnt=1'
const AVATAR_OPEN_URL = 'https://sketchfab.com/3d-models/free-k-vrc-from-love-death-robots-f6875afc0b3c4d19a17a8147f0b13626'
const AVATAR_IMAGE_SRC = '/assets/PCA-AVATAR.png'
const AVATAR_LOGO_SRC = '/assets/PCA.png'
            ...
            <div className={styles.avatarViewer}>
              {!avatarLoadFailed ? (
                <div className={styles.avatarStage}>
                  ...
                  />
                  <img src={AVATAR_LOGO_SRC} alt="" aria-hidden className={styles.avatarChestLogo} />
                </div>
              ) : (
                <img src={AVATAR_IMAGE_SRC} alt="Robot PCA" className={styles.avatarImage} loading="lazy" />
              )}
              <a
                href={AVATAR_OPEN_URL}
                target="_blank"
                rel="noopener noreferrer"
                className={styles.avatarOpenBtn}
              >
                Ouvrir le robot 3D
              </a>
            </div>
        ...
        <div className={styles.sectionInner}>
          ...
          <div className={styles.cards}>
            ...
            >
              ...
              <h3>Dashboard RH</h3>
              <p>Tableau de bord candidatures, analytics detaillees et metriques temps reel (workflow, pipelines n8n).</p>
