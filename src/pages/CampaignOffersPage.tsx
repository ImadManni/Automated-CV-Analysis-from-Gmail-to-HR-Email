...
import { demoCampaignOffers, demoCampaigns } from '@/mock/demoData'
    ...
    const load = async () => {
      ...
      try {
        ...
        if (USE_DEMO_FALLBACK) {
          const fallbackCampaign = demoCampaigns.find((c) => String(c.id) === String(campaignId))
          setCampaign(fallbackCampaign || null)
          setOffers(demoCampaignOffers[String(campaignId)] ?? [])
        } else {
          setCampaign(null)
          setOffers([])
        }
